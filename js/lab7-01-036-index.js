...
function getTime() {
    ...
    timeShow.innerText = `${year}年${month}月${day}日 ${week} ${h}:${m}:${s}`;
}
getTime();
...
function getCountDown() {
    ...
    if (diff <= 0) {
        countShow.innerText = '0天00时00分00秒';
        return;
    }
    ...
    countShow.innerText = `${day}天${String(hour).padStart(2, '0')}时${String(min).padStart(2, '0')}分${String(sec).padStart(2, '0')}秒`;
}
getCountDown();
